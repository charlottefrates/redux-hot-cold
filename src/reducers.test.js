...
describe('Test the reducer file', () => {
    ...
    describe('how newGame get initiated', () => {
    ...
    describe('how it switches from information to main game with toggleInfoModal', () => {
